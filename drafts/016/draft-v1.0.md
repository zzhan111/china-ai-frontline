...
**基准 2:Artificial Analysis Intelligence Index v4.1**
- GLM-5.2 = 51 分(#1 open-weights)
- 对比:MiniMax-M3 44 / DeepSeek V4 Pro 44 / Kimi K2.6 43

来源:https://artificialanalysis.ai/articles/glm-5-2-is-the-new-leading-open-weights-model-on-the-artificial-analysis-intelligence-index（HN 913p / 444c）
...
**基准 4:Design Arena WebDev 评估(场景化)**
- GLM-5.2 = WebDev Non-Agentic #1,「first model to beat Claude Fable 5」
- 但限定条件:single-turn HTML,非 agentic + 非视觉
- Opus 4.8 仍领先 Game Dev / Data Visualization / 3D Design / UI Component 4 个细分榜

来源:https://notes.designarena.ai/how-glm-5-2-beat-fable-5-at-website-design/
