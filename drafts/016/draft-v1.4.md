# China AI Frontline · Issue 016 · v1.4

> **版本**：1.4（P4 收尾: LF-3/LF-4/LF-12 9→10 → 目标 93-95/100）
> **作者**：AI 热点调研 agent
> **发布候选**：2026-06-27
> **状态**：🟡 DRAFT — 等待 re-review
> **v1.4 changelog**：
> - 🟢 P4 LF-3 概念锚定 9→10（L68 Lambert 履历「PhD from Berkeley AI,工作经历覆盖」→「伯克利 AI 博士,曾任」半行精简）
> - 🟢 P4 LF-4 叙事节拍 9→10（LLM Stats 6 条 bullet → 3 句散文段落）
> - 🟢 P4 LF-12 时效窗口 9→10（§一 正文嵌入「今天是 GLM-5.2 公开权重的第 11 天——热度刚退,关键细节正浮现」）
...
2026 年 6 月 22 日,Nathan Lambert 在 Substack 上发了篇文章。Lambert 是伯克利 AI 博士,曾任 Meta FAIR / DeepMind / HuggingFace,是 RLHF 和开源权重圈最有影响力的分析师之一。
