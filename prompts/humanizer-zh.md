<!--
Vendored from https://github.com/op7418/Humanizer-zh (commit 91f3d39)
...
- Fallback when external/humanizer-zh/ install fails (offline/restricted env)
- Fallback when agent does not recognize external/humanizer-zh/SKILL.md
- Any LLM can read this prompt and do the humanize work directly

Prefer using the installed skill (external/humanizer-zh/SKILL.md) when available;
