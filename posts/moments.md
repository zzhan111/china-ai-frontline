...
acknowledged: ai-flag:over-structure（短文出现数字 emoji）— eval false positive：正文无数字 emoji (1️⃣2️⃣3️⃣），bug 在 text.count(c) 对普通数字字符匹配到含 U+20E3 variant selector 的 codepoint 组合。本 post 正文纯文本，无结构化 emoji。
